...
from ...core.bbox import LiDARInstance3DBoxes, PolarInstance3DBoxes
...
class LoadAnnotationsBEVDepth(object):
    ...
    def __init__(self, bda_aug_conf, classes, is_train=True, polar=False):
    ...
    def __call__(self, results):
        ...
        if self.polar:
            results['gt_bboxes_3d'] = PolarInstance3DBoxes(gt_boxes, box_dim=gt_boxes.shape[-1], origin=(0.5, 0.5, 0.5))
        else:
